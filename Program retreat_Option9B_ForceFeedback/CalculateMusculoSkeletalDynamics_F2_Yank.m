function [error] = CalculateMusculoSkeletalDynamics_F2_Yank(q,qd,qdd,lMtilda, lM_projected, kFpe, vMtilda, a_ext, a_flex, data_exp, coeff_LMT_ma, params_OS, shift, B, info, Fsrs, dFsrsdt, Fsrs_del, dFsrs_deldt, kR, kY, tres, Fce_del, dFce_deldt)
...
% FMce 
Fce_ext  = (a_ext + kR * Fsrs_del + kY * dFsrs_deldt - tres).* FMltilda(1,:).* FMvtilda(1,:) + Fsrs;      % FMce = fse.* lM ./(lMT-lT) - Fpe;  
