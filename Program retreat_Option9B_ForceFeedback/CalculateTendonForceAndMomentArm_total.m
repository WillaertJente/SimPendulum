function [FT, ma, dlMdt, err, lM, lT, Fce, Fpe, FM] = CalculateTendonForceAndMomentArm_total(x, params, lMtilda, a, sn, shift, vMtilda, lM_projected, coeff_LMT_ma, offset, kFpe, Fsrs)
