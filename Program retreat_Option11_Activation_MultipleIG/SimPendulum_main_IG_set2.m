...
info.option = 'Opt11_IG_set2'      % Name to save results
...
opti.set_initial(a_ext, 0.005 );%0.01
opti.set_initial(a_flex, 0.001  ); %0.01 guess(l)
opti.set_initial(kFpe, 0.15);
opti.set_initial(B, 0.05); % 0.1 
...
opti.set_initial(dt1,0.01); 
opti.set_initial(kR, 0.001);  
