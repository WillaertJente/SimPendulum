function [ xdot ] = pendulumStateDerivativeMuscleSRS(t, x , inputdata, params )
...
[dlMtilde_ext,FT_ext,dFsrs, ~] = FiberLengthSRSOde_ext(a_ext,x(3)',lMT_ext, params.MTparams_ext, params.Fvparam, params.Fpparam, params.Faparam, params, x(2),x(4), inputdata); 
