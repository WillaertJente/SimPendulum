function [ xdot ] = pendulumStateDerivativeMuscle(t, x , params )
...
% state: fiber length
[dx,FT] = FiberLengthOde(a,x(4)',LMT, params.MTparams, params.Fvparam, params.Fpparam, params.Faparam);
...
% xdot(2) = 1/I *(-m*g*l*cos(x(1)) + Tlimit + Td + FT(1)*ma(1)); % + FT(2)*ma(2));
