function [dlMdt,FT] = FiberLengthOde(a,lMtilda,lMT,params, Fvparam, Fpparam, Faparam)
% Try to vectorize it
FMo = params(1,:);              %Peak isometric muscle force
lMo = params(2,:);              %Optimal muscle fiber length
