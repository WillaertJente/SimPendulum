function [ xdot ] = pendulumStateDerivativeMuscleSRS_JW(t, x , params )
...
% state: fiber length
[dx,FT,dFsrs] = FiberLengthSRSOde(a,x(4)',LMT, params.MTparams, params.Fvparam, params.Fpparam, params.Faparam, params, x(2),x(5));
...
% xdot(2) = 1/I *(-m*g*l*cos(x(1)) + Tlimit + x(3) + FT(1)*ma(1)  + Td ); % + FT(2)*ma(2));
