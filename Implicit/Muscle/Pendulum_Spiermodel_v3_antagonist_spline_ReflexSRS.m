...
s.tr = [3 4];                                                                                 % subject trials (number of trials)
pathmain = pwd;
...
opt  = '_Refl1';   % Option used as name to save results
