...
info.trial  =  12 % Trial number
info.option = 'Opt14_Activation_TanH_tresh_FS2_IG2'      % Name to save results
...
% IG
IG.a_ext = 0.005; IG.a_flex = 0.001; 
IG.kFpe = 0.15; IG.B = 0.05; 
IG.dt1 = 0.01; IG.kR = 0.001; 
