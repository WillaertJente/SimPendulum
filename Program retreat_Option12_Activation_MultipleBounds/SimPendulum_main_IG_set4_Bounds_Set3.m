...
info.subj   = 'CP2';           % Subject name
info.trial  = 5 % Trial number
info.option = 'Opt12_IG_set4_Bounds_Set3_NoTresh'      % Name to save results
...
opti.set_initial(a_ext, 0.0001 );%0.01
opti.set_initial(a_flex, 0.0005  ); %0.01 guess(l)
