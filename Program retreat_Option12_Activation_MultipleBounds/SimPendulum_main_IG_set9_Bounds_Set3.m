...
info.option = 'Opt11_IG_set9_Bounds_Set3_NoTresh'      % Name to save results
...
% Bounds
[Ub, Lb] = SelectBounds_Set3(data_exp);
...
opti.set_initial(a_ext, 0.1 );%0.01
opti.set_initial(a_flex, 0.05  ); %0.01 guess(l)
opti.set_initial(kFpe, 0.2);
opti.set_initial(B, 0.03); % 0.1 
...
opti.set_initial(dt1,0.001); 
opti.set_initial(kR, 0.1);  
