function [error] = CalculateMusculoSkeletalDynamics_F1_Refl(q,qd,qdd,lMtilda, lMtilda_init, lM_projected, kFpe, vMtilda, a_ext, a_flex, data_exp, coeff_LMT_ma, params_OS, shift, B, info, Fsrs_del, dFsrs_deldt, kR)
...
% Total error
error = [error_force error_musclegeometry error_skelet error_Fsrs_del];
end
