function [params_OS] = ReadOpenSimParams(info, params, muscles)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
import org.opensim.modeling.*

% Model 
model_path = [info.path,'CP10_ScaledModel_ScaledForces.osim'];    
...
% Inertial params
    ...
    params_inert.I_OS    = inertia.get(0,0) + params_inert.mass_OS * params_inert.lc_OS ^2; %(apply steiner) 
