function [Fsrs] = CalculateFsrsForward(lMtilda_forward_F1,lMtilda_init, a_ext, kSRS, params_OS)
...
stretch = lMtilda_forward_F1(end)-lMtilda_init; 
...
% ext 
num3_ext     = lMtilda_forward_F1(end)-b23;
den3_ext     = b33+b43*lMtilda_forward_F1(end);
FMtilda3_ext = b13*exp(-0.5*num3_ext.^2./den3_ext.^2);

num1_ext     = lMtilda_forward_F1(end)-b21;
den1_ext     = b31+b41*lMtilda_forward_F1(end);
FMtilda1_ext = b11*exp(-0.5*num1_ext.^2./den1_ext.^2);

num2_ext     = lMtilda_forward_F1(end)-b22;
den2_ext     = b32+b42*lMtilda_forward_F1(end);
FMtilda2_ext = b12*exp(-0.5*num2_ext.^2./den2_ext.^2);

FMltilda     = FMtilda1_ext+FMtilda2_ext+FMtilda3_ext;

Fsrs = stretch.*FMltilda*a_ext*kSRS; 
