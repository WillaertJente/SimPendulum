...
for i = 1:N
    ...
    errorDyn_meshStart = CalculateMusculoSkeletalDynamics_F1(q(:,i),qd_implicit,qdd_implicit,lMtilda(:,i),lM_projected,kFpe, vMtilda_implicit,a_ext, a_flex, data_exp, coeff_LMT_ma, params_OS, shift, B, info);
    errorDyn_meshEnd = CalculateMusculoSkeletalDynamics_F1(q_next,qd_next,qdd_implicit_next,lMtilda_next,lM_projected_next,kFpe, vMtilda_implicit_next,a_ext, a_flex, data_exp, coeff_LMT_ma, params_OS, shift, B, info);
